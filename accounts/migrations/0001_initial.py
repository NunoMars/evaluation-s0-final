    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.BigIntegerField(blank=True, default='0000000000')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sorted_card', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clairvoyance.majorarcana', verbose_name='Tiragem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sorted_cards_date', models.DateTimeField(auto_now_add=True)),
                ('daily_sorted_cards', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clairvoyance.majorarcana', verbose_name='Tiragem')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
